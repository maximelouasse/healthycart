...
*/
    ...
    const { createItem, readItem, readOneItem, updateItem, deleteItem, addProductList, deleteProductList } = require('./list.controller');
//
    ...
    class MyRouterClass {
        ...
        routes() {
            ...
            myRouter.post('/', (req, res) => {
                ...
                const { miss, extra, ok } = checkFields( Mandatories.list, req.body );
            ...
            myRouter.put('/:id/product', (req, res) => {
                deleteProductList(req)
                .then( apiResponse => {
                    return res.status(200).json({
                        message: 'Data updated',
                        data: apiResponse,
